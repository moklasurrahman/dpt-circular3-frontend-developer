...
const Navbar = () => {
    ...
    return (
        <nav className=" bg-[#466ca8] w-full z-20 border-b border-gray-200">
            <div className="px-2 md:px-0 md:w-[95%] xl:w-[85%] 2xl:w-[85%] flex flex-wrap items-center justify-between mx-auto p-4">
           
            <img src="https://populartravel.com.bd/img/dhaka-logo.png" class="h-9" alt="Flowbite Logo" />
                ...
                <div className={`items-center justify-between w-full md:flex md:w-auto md:order-1 ${isMobileMenuOpen ? 'block' : 'hidden'}`} id="navbar-sticky">
                    <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-800 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-transparent  dark:border-gray-700 ">
                        <li>
                            <a
                                href="#"
